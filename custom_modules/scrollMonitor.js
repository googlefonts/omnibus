        ...
        var h = i(1),
            ...
            u = function() {
                ...
                return t.prototype.listenToDOM = function() {
                    ...
                    var s = e !== this.viewportWidth || i !== this.contentWidth;
            ...
            this.triggerCallbacks = function(t) {
                ...
                if (!this.locked) {
                    ...
                    if (this.watchItem.nodeName) {
                        ...
                        for (var s = 0, n = this.container; n.containerWatcher;) s += n.containerWatcher.left - n.containerWatcher.container.viewportleft, n = n.containerWatcher.container;
                        var r = this.watchItem.getBoundingClientRect();
                        this.left = r.left + this.container.viewportleft - s, this.right = r.right + this.container.viewportleft - s, "none" === i && (this.watchItem.style.display = i)
