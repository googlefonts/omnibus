...
if (typeof window !== 'undefined' && typeof document !== 'undefined') {
  ...
  const GoogleFontsBadge = {
    init: function(opts) {
      let scrollValue = 0;
      const badgeParent = opts || doc.body;
      doc.body.appendChild(badgeContainer);
      doc.head.appendChild(badgeStyles);

      badgeParent.addEventListener('touchmove', _.throttle(ScrollStart, 500), false);
      badgeParent.addEventListener('scroll', _.throttle(Scroll, 500), false);
  ...
  const gfBadge = function(opts) {
    GoogleFontsBadge.main(opts);
