module.exports = {
   ...
   */
    ...
    var CONSTRAINT = 1 - 0.18,
       ...
       */
        ...
        /**
       * scroll-snap-destination css value
       * @type {String}
       */
        SCROLL_SNAP_DESTINATION = '0% 90%';
   ...
   */
    var handlerDelayed = function() {
        ...
        var direction = {
                y: (scrollStart.y - lastScrollObj.scrollTop > 0)
                    ? -1
                    : 1,
                x: (scrollStart.x - lastScrollObj.scrollLeft > 0)
                    ? -1
                    : 1
            },
            snapPoint;
   ...
   */
    var smoothScroll = function(obj, end, callback) {
        var start = {
            ...
            requestAnimationFrame = w.requestAnimationFrame || w.mozRequestAnimationFrame || w.webkitRequestAnimationFrame || function(fn) {
                w.setTimeout(fn, 15);
            },
